...
def main(argv):
    ...
    opened_process = subprocess.Popen(["cmake", toolchain_args, "-DTARGETPLATFORM=" + target_platform, "-G", "CodeBlocks - Unix Makefiles", "../.."], cwd=output_directory, stdout=PIPE, bufsize=1)
